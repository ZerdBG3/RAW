...
| [`monk`](https://github.com/ZerdBG3/RAW/blob/main/Features.md#monk-%EF%B8%8F-monk) 🔧 | - | - | $${\color{lime}{\text{enabled}}}$$ | Changes to most monk base features. |
...
| [`skillCheck_critFail`](https://github.com/ZerdBG3/RAW/blob/main/Features.md#disable-critical-fail-on-checks-%EF%B8%8F-skillcheck_critfail) | - | - | $${\color{lime}{\text{enabled}}}$$ | Disables the possibility of a critical fail on ability or skill checks and saving throws. |
